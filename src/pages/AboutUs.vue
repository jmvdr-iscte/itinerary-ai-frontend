...
// Testimonials
const testimonials = [
  { quote: '"TripVibes completely transformed our family vacation. The AI understood exactly what activities would keep both our teenagers and younger children engaged. It was like having a personal travel agent who really knew us."', name: 'Jennifer K.', type: 'Family Traveler', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=60&q=80' },
  { quote: '"As a solo traveler, I was amazed at how TripVibes created an itinerary that perfectly balanced adventure and relaxation. I discovered hidden gems I would never have found on my own. This is the future of travel planning!"', name: 'Michael T.', type: 'Adventure Seeker', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=60&q=80' },
  { quote: '"My husband and I have very different travel preferences, but TripVibes somehow created an itinerary that made us both happy. The AI\'s ability to balance different interests is truly impressive. We\'ll never plan a trip any other way."', name: 'Sarah L.', type: 'Couple Traveler', image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-1.2.1&auto=format&fit=crop&w=60&q=80' }
];
  ...
  <div class="bg-[#0F1629] text-white min-h-screen flex flex-col w-screen overflow-hidden">
    ...
    <main class="flex-1 w-full">
        ...
        <div class="container mx-auto px-6">
          ...
          <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2 md:pl-12">
              ...
              <p class="text-gray-300 mb-6">TripVibes was born from a simple observation: planning the perfect trip is time-consuming, stressful, and often results in generic experiences that don't match travelers' unique preferences.</p>
        ...
        <div class="container mx-auto px-6">
          ...
          <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 md:pr-12 mb-10 md:mb-0">
              ...
              <p class="text-gray-300 mb-6">At the heart of TripVibes is our proprietary AI engine that analyzes thousands of data points to create travel experiences that feel like they were crafted just for you.</p>
              ...
              <p class="text-gray-300">The more you use TripVibes, the smarter it gets. Our AI learns from your feedback and travel patterns, continuously improving its recommendations to match your evolving preferences.</p>
            </div>
            <div class="md:w-1/2">
      ...
      <section class="py-20 bg-[#0F1629]">
        <div class="container mx-auto px-6">
          <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-white">How TripVibes Works</h2>
            <div class="w-16 h-1 bg-gradient-to-r from-purple-500 to-indigo-500 mx-auto mt-4 mb-6"></div>
      ...
      <!-- <section class="py-20 bg-[#1A2333]">
        <div class="container mx-auto px-6">
          <div class="text-center mb-16">
            ...
            <div class="w-16 h-1 bg-gradient-to-r from-purple-500 to-indigo-500 mx-auto mt-4 mb-6"></div>
            <p class="text-gray-300 max-w-3xl mx-auto">The principles that guide everything we do at TripVibes</p>
          </div>
       ...
       <!-- <section class="py-20 bg-[#1A2333]">
         <div class="container mx-auto px-6">
           <div class="text-center mb-16">
             ...
             <div class="w-16 h-1 bg-gradient-to-r from-purple-500 to-indigo-500 mx-auto mt-4 mb-6"></div>
             <p class="text-gray-300 max-w-3xl mx-auto">Real experiences from travelers who've used TripVibes</p>
           </div>
           <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
