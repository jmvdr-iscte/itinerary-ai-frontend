...
const aiFeatures = [
  ...
  },
  {
    ...
    description: 'Optimizes routes for efficiency'
  },
  {
    title: 'Preference Matching',
    icon: 'fa-users',
    description: 'Aligns activities with your interests'
  },
  {
    title: 'Time Optimization',
    icon: 'fa-clock',
    description: 'Balances activities and rest'
  }
];
...
const workflowSteps = [
  {
    ...
    description: 'Tell us about your travel style, interests, and must-see attractions'
  },
  {
...
const companyValues = [
  {
    title: 'Innovation',
    icon: 'fa-lightbulb',
    description: 'We constantly push the boundaries of what\'s possible in travel planning, leveraging cutting-edge technology to create better experiences.'
  },
  {
    title: 'Personalization',
    icon: 'fa-fingerprint',
    description: 'We believe that every traveler is unique, and we\'re committed to creating experiences that reflect individual preferences and interests.'
  },
  {
    title: 'Simplicity',
    icon: 'fa-feather',
    description: 'We make complex travel planning effortless, allowing travelers to focus on enjoying their experiences rather than organizing them.'
  },
  {
    title: 'Quality',
    icon: 'fa-award',
    description: 'We\'re dedicated to excellence in every itinerary we create, ensuring that each recommendation meets our high standards.'
  },
  {
    title: 'Customer-Centricity',
    icon: 'fa-heart',
    description: 'We put travelers at the center of everything we do, listening to feedback and continuously improving our service.'
  },
  {
    title: 'Global Perspective',
    icon: 'fa-globe',
    description: 'We embrace diversity in travel experiences, celebrating the unique cultures and attractions that make our world worth exploring.'
  }
];
...
const teamMembers = [
  {
    ...
    description: 'Travel enthusiast with a background in AI and machine learning',
    image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
  },
  {
    name: 'Samantha Chen',
    position: 'CTO & Co-Founder',
    description: 'AI expert with a passion for solving complex problems',
    image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
  },
  {
    name: 'David Wilson',
    position: 'Head of Travel Experience',
    description: 'Former travel guide with knowledge of destinations worldwide',
  ...
  },
  {
    ...
    description: 'Designer focused on creating intuitive, beautiful experiences',
...
const testimonials = [
  {
    quote: '"TripFlow completely transformed our family vacation. The AI understood exactly what activities would keep both our teenagers and younger children engaged. It was like having a personal travel agent who really knew us."',
    name: 'Jennifer K.',
    type: 'Family Traveler',
    image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=60&q=80'
  },
  {
    quote: '"As a solo traveler, I was amazed at how TripFlow created an itinerary that perfectly balanced adventure and relaxation. I discovered hidden gems I would never have found on my own. This is the future of travel planning!"',
    name: 'Michael T.',
    type: 'Adventure Seeker',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=60&q=80'
  },
  {
    quote: '"My husband and I have very different travel preferences, but TripFlow somehow created an itinerary that made us both happy. The AI\'s ability to balance different interests is truly impressive. We\'ll never plan a trip any other way."',
    name: 'Sarah L.',
    type: 'Couple Traveler',
    image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-1.2.1&auto=format&fit=crop&w=60&q=80'
  }
];
...
<template>
  <div class="bg-[#0F1629] text-white min-h-screen flex flex-col w-screen overflow-hidden">
      ...
      <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row items-center">
          ...
          <div class="md:w-1/2 md:pl-12">
            ...
            <p class="text-gray-300 mb-6">TripFlow was born from a simple observation: planning the perfect trip is time-consuming, stressful, and often results in generic experiences that don't match travelers' unique preferences.</p>
      ...
      <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 md:pr-12 mb-10 md:mb-0">
            ...
            <p class="text-gray-300 mb-6">At the heart of TripFlow is our proprietary AI engine that analyzes thousands of data points to create travel experiences that feel like they were crafted just for you.</p>
            ...
            <p class="text-gray-300">The more you use TripFlow, the smarter it gets. Our AI learns from your feedback and travel patterns, continuously improving its recommendations to match your evolving preferences.</p>
          </div>
          <div class="md:w-1/2">
    ...
    <section class="py-20 bg-[#0F1629]">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-4xl font-bold text-white">How TripFlow Works</h2>
          <div class="w-16 h-1 bg-gradient-to-r from-purple-500 to-indigo-500 mx-auto mt-4 mb-6"></div>
    ...
    <section class="py-20 bg-[#1A2333]">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          ...
          <div class="w-16 h-1 bg-gradient-to-r from-purple-500 to-indigo-500 mx-auto mt-4 mb-6"></div>
          <p class="text-gray-300 max-w-3xl mx-auto">The principles that guide everything we do at TripFlow</p>
        </div>
    ...
    <section class="py-20 bg-[#1A2333]">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          ...
          <div class="w-16 h-1 bg-gradient-to-r from-purple-500 to-indigo-500 mx-auto mt-4 mb-6"></div>
          <p class="text-gray-300 max-w-3xl mx-auto">Real experiences from travelers who've used TripFlow</p>
        </div>
